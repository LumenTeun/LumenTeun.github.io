...
var _ahstro$ahstro$Constants$terminalId = 'terminal-terminal';
var _ahstro$ahstro$Constants$terminalInputId = 'terminal-input';
...
var _ahstro$ahstro$Desktop_Css$windowTop = _elm_lang$html$Html_Attributes$class('Desktop-windowTop');
var _ahstro$ahstro$Desktop_Css$windowCloseButton = _elm_lang$html$Html_Attributes$class('Desktop-windowCloseButton');
var _ahstro$ahstro$Desktop_Css$windowChildren = _elm_lang$html$Html_Attributes$class('Desktop-windowChildren');
var _ahstro$ahstro$Desktop_Css$window = _elm_lang$html$Html_Attributes$class('Desktop-window');
var _ahstro$ahstro$Desktop_Css$desktop = _elm_lang$html$Html_Attributes$class('Desktop-desktop');
...
var _ahstro$ahstro$Desktop_View$window = F2(
	function (name, children) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _ahstro$ahstro$Desktop_Css$window,
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _ahstro$ahstro$Desktop_Css$windowTop,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _ahstro$ahstro$Desktop_Css$windowCloseButton,
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _ahstro$ahstro$Desktop_Css$windowChildren,
							_1: {ctor: '[]'}
						},
						children),
					_1: {ctor: '[]'}
...
var _ahstro$ahstro$Desktop_View$desktop = function (children) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _ahstro$ahstro$Desktop_Css$desktop,
			_1: {ctor: '[]'}
		},
		children);
};

var _ahstro$ahstro$Model$init = {
	ctor: '_Tuple2',
	_0: {
		commandHistory: _Skinney$elm_array_exploration$Array_Hamt$empty,
...
var _ahstro$ahstro$Model$Model = F4(
	function (a, b, c, d) {
		return {commandHistory: a, commandHistoryIndex: b, terminalOutput: c, terminalInput: d};
	});
...
var _ahstro$ahstro$Update$ScrollTerminalInputForward = {ctor: 'ScrollTerminalInputForward'};
var _ahstro$ahstro$Update$ScrollTerminalInputBack = {ctor: 'ScrollTerminalInputBack'};
var _ahstro$ahstro$Update$ClearTerminalInput = {ctor: 'ClearTerminalInput'};
var _ahstro$ahstro$Update$ClearTerminalOutput = {ctor: 'ClearTerminalOutput'};
var _ahstro$ahstro$Update$RunCommand = {ctor: 'RunCommand'};
var _ahstro$ahstro$Update$SetTerminalInput = function (a) {
	return {ctor: 'SetTerminalInput', _0: a};
};
var _ahstro$ahstro$Update$TaskResult = function (a) {
	return {ctor: 'TaskResult', _0: a};
};
var _ahstro$ahstro$Update$FocusTerminalInput = {ctor: 'FocusTerminalInput'};
var _ahstro$ahstro$Update$NoOp = {ctor: 'NoOp'};
var _ahstro$ahstro$Update$Backward = {ctor: 'Backward'};
var _ahstro$ahstro$Update$Forward = {ctor: 'Forward'};
var _ahstro$ahstro$Update$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p0 = msg;
			switch (_p0.ctor) {
				case 'FocusTerminalInput':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(
							_elm_lang$core$Task$attempt,
							_ahstro$ahstro$Update$TaskResult,
							_elm_lang$dom$Dom$focus(_ahstro$ahstro$Constants$terminalInputId))
					};
				case 'TaskResult':
					var _v1 = _ahstro$ahstro$Update$NoOp,
						_v2 = model;
					msg = _v1;
					model = _v2;
					continue update;
				...
				case 'ScrollTerminalInputBack':
					return A2(_ahstro$ahstro$Update$scrollTerminalInput, _ahstro$ahstro$Update$Backward, model);
				case 'ScrollTerminalInputForward':
					return A2(_ahstro$ahstro$Update$scrollTerminalInput, _ahstro$ahstro$Update$Forward, model);
				case 'RunCommand':
					var scrollToBottom = A2(
						_elm_lang$core$Task$attempt,
						_ahstro$ahstro$Update$TaskResult,
						_elm_lang$dom$Dom_Scroll$toBottom(_ahstro$ahstro$Constants$terminalId));
					var command = model.terminalInput;
					var nextCommandHistory = A2(_Skinney$elm_array_exploration$Array_Hamt$push, command, model.commandHistory);
					var nextModelBase = _elm_lang$core$Native_Utils.update(
						model,
						{
							terminalInput: '',
							commandHistory: nextCommandHistory,
							commandHistoryIndex: _Skinney$elm_array_exploration$Array_Hamt$length(nextCommandHistory)
						});
					var _p1 = command;
					if (_p1 === 'clear') {
						var _v4 = _ahstro$ahstro$Update$ClearTerminalOutput,
							_v5 = nextModelBase;
						msg = _v4;
						model = _v5;
						continue update;
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								nextModelBase,
								{
									terminalOutput: {ctor: '::', _0: command, _1: model.terminalOutput}
								}),
							{
								ctor: '::',
								_0: scrollToBottom,
...
var _ahstro$ahstro$Update$scrollTerminalInput = F2(
	function (scrollDirection, model) {
		var nextCommandHistoryIndex = function () {
			var _p2 = scrollDirection;
			if (_p2.ctor === 'Backward') {
				return model.commandHistoryIndex - 1;
			} else {
				return model.commandHistoryIndex + 1;
			}
		}();
		var maybeNextTerminalInput = A2(_Skinney$elm_array_exploration$Array_Hamt$get, nextCommandHistoryIndex, model.commandHistory);
		var _p3 = maybeNextTerminalInput;
		if (_p3.ctor === 'Just') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{commandHistoryIndex: nextCommandHistoryIndex, terminalInput: _p3._0}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		} else {
			var _p4 = scrollDirection;
			if (_p4.ctor === 'Backward') {
				return A2(_ahstro$ahstro$Update$update, _ahstro$ahstro$Update$NoOp, model);
			} else {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							commandHistoryIndex: _Skinney$elm_array_exploration$Array_Hamt$length(model.commandHistory),
							terminalInput: ''
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _ahstro$ahstro$Helpers$link = F2(
	function (url, txt) {
		return A2(
...
var _ahstro$ahstro$Helpers$line = _elm_lang$html$Html$div(
	{ctor: '[]'});
...
var _ahstro$ahstro$Terminal_Css$terminal = _elm_lang$html$Html_Attributes$class('Terminal-terminal');
var _ahstro$ahstro$Terminal_Css$prompt = _elm_lang$html$Html_Attributes$class('Terminal-prompt');
var _ahstro$ahstro$Terminal_Css$outputLine = _elm_lang$html$Html_Attributes$class('Terminal-outputLine');
var _ahstro$ahstro$Terminal_Css$inputInput = _elm_lang$html$Html_Attributes$class('Terminal-inputInput');
var _ahstro$ahstro$Terminal_Css$input = _elm_lang$html$Html_Attributes$class('Terminal-input');

var _ahstro$ahstro$Terminal_Commands$github = _ahstro$ahstro$Helpers$link('https://github.com/ahstro');
var _ahstro$ahstro$Terminal_Commands$gitlab = _ahstro$ahstro$Helpers$link('https://gitlab.com/ahstro');
var _ahstro$ahstro$Terminal_Commands$getAboutOutput = function (args) {
	var _p0 = args;
	switch (_p0) {
		case 'ahstro':
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text('I\'m ahstro or Anton Strömkvist. I like coding, psychedelics, rock climbing, and loads of other stuff. I also made this website. Nice meeting you!'),
				_1: {ctor: '[]'}
			};
		case 'coding':
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text('I have no idea when I started coding. I remember trying to figure out a C++ compiler (with no success) when I was around 10, as well as making some crude websites. For me, coding isn\'t simply about software though; coding is just a symptom of my fascination with everything and an almost innate desire to tinker and help out with stuff. Naturally, I\'ve been a huge fan of open source software since I first came into contact with (and comprehended) the concept. If you\'re curious, you can check out what I\'ve done on my '),
				_1: {
					ctor: '::',
					_0: _ahstro$ahstro$Terminal_Commands$github('GitHub'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(' and '),
						_1: {
							ctor: '::',
							_0: _ahstro$ahstro$Terminal_Commands$gitlab('GitLab'),
							_1: {
								ctor: '::',
		...
		case 'contact':
			return {
				ctor: '::',
				_0: _ahstro$ahstro$Helpers$line(
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(' email: '),
						_1: {
							ctor: '::',
							_0: A2(_ahstro$ahstro$Helpers$link, 'mailto:anton@stromkvist.com', 'anton@stromkvist.com'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: _ahstro$ahstro$Helpers$line(
						{
							...
							_1: {
								ctor: '::',
								_0: _ahstro$ahstro$Terminal_Commands$github('github.com/ahstro'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: _ahstro$ahstro$Helpers$line(
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('gitlab: '),
								_1: {
									ctor: '::',
									_0: _ahstro$ahstro$Terminal_Commands$gitlab('gitlab.com/ahstro'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: _ahstro$ahstro$Helpers$line(
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('   pgp: '),
									_1: {
										ctor: '::',
										_0: A2(_ahstro$ahstro$Helpers$link, 'https://pgp.mit.edu/pks/lookup?op=vindex&search=0x50A3573EFBFA9867', '0x50A3573EFBFA9867'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
		...
		default:
			return {
				...
				_0: _ahstro$ahstro$Helpers$line(
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('usage: about [topic]'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: _ahstro$ahstro$Helpers$line(
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(' ahstro'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _ahstro$ahstro$Helpers$line(
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(' coding'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _ahstro$ahstro$Helpers$line(
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(' psychedelics'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _ahstro$ahstro$Terminal_Commands$splitAtFirstWhitespace = A2(
	_elm_lang$core$Regex$split,
	_elm_lang$core$Regex$AtMost(1),
	_elm_lang$core$Regex$regex('\\s+'));
var _ahstro$ahstro$Terminal_Commands$getKeyBinding = function (key) {
	var _p1 = _elm_lang$core$String$toLower(key);
	switch (_p1) {
		case 'arrowup':
			return _ahstro$ahstro$Update$ScrollTerminalInputBack;
		case 'arrowdown':
			return _ahstro$ahstro$Update$ScrollTerminalInputForward;
		default:
			return _ahstro$ahstro$Update$NoOp;
	}
};
var _ahstro$ahstro$Terminal_Commands$getCtrlKeyBinding = function (key) {
	var _p2 = _elm_lang$core$String$toLower(key);
	switch (_p2) {
		case 'l':
			return _ahstro$ahstro$Update$ClearTerminalOutput;
		case 'u':
			return _ahstro$ahstro$Update$ClearTerminalInput;
		case 'p':
			return _ahstro$ahstro$Update$ScrollTerminalInputBack;
		case 'n':
			return _ahstro$ahstro$Update$ScrollTerminalInputForward;
...
var _ahstro$ahstro$Terminal_Commands$getOutput = function (command) {
	var _p3 = function () {
		var _p4 = _ahstro$ahstro$Terminal_Commands$splitAtFirstWhitespace(command);
		if (_p4.ctor === '::') {
			if (_p4._1.ctor === '::') {
	...
	switch (_p5) {
		case 'about':
			return _ahstro$ahstro$Terminal_Commands$getAboutOutput(tail);
		case 'help':
			return {
				ctor: '::',
				_0: _ahstro$ahstro$Helpers$line(
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Here are some available commands:'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: _ahstro$ahstro$Helpers$line(
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('echo'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
		...
		case 'echo':
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text(tail),
				_1: {ctor: '[]'}
			};
		case 'hello':
			return {
				...
				_0: _ahstro$ahstro$Helpers$line(
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'ash: command not found: ', command)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _ahstro$ahstro$Helpers$line(
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Try \'help\' if you\'re lost'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _ahstro$ahstro$Terminal_Commands$KeyCombination = F2(
	function (a, b) {
		return {key: a, ctrlKey: b};
	});
var _ahstro$ahstro$Terminal_Commands$handleKeyCombination = A2(
	_elm_lang$html$Html_Events$on,
	'keydown',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (_p6) {
			var _p7 = _p6;
			var _p8 = _p7.key;
			return _p7.ctrlKey ? _elm_lang$core$Json_Decode$succeed(
				_ahstro$ahstro$Terminal_Commands$getCtrlKeyBinding(_p8)) : _elm_lang$core$Json_Decode$succeed(
				_ahstro$ahstro$Terminal_Commands$getKeyBinding(_p8));
		},
		A3(
			_elm_lang$core$Json_Decode$map2,
			_ahstro$ahstro$Terminal_Commands$KeyCombination,
...
var _ahstro$ahstro$Terminal_View$prompt = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _ahstro$ahstro$Terminal_Css$prompt,
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _ahstro$ahstro$Terminal_View$viewOutput = function (command) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _ahstro$ahstro$Terminal_Css$outputLine,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _ahstro$ahstro$Terminal_View$prompt,
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(command),
						_1: {ctor: '[]'}
					}
				}),
			_1: _ahstro$ahstro$Terminal_Commands$getOutput(command)
		});
};
var _ahstro$ahstro$Terminal_View$terminal = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _ahstro$ahstro$Terminal_Css$terminal,
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_ahstro$ahstro$Update$FocusTerminalInput),
				_1: {
					ctor: '::',
					_0: _ahstro$ahstro$Terminal_Commands$handleKeyCombination,
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id(_ahstro$ahstro$Constants$terminalId),
						_1: {ctor: '[]'}
					}
				}
			}
		},
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$List$map,
					_ahstro$ahstro$Terminal_View$viewOutput,
					_elm_lang$core$List$reverse(model.terminalOutput))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _ahstro$ahstro$Terminal_Css$input,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_ahstro$ahstro$Update$SetTerminalInput),
									_1: {
										ctor: '::',
										_0: _elm_community$html_extra$Html_Events_Extra$onEnter(_ahstro$ahstro$Update$RunCommand),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.terminalInput),
											_1: {
												ctor: '::',
												_0: _ahstro$ahstro$Terminal_Css$inputInput,
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id(_ahstro$ahstro$Constants$terminalInputId),
													_1: {
														ctor: '::',
														_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-label', 'terminal input'),
														_1: {ctor: '[]'}
													}
												}
											}
...
var _ahstro$ahstro$View$view = function (model) {
	return _ahstro$ahstro$Desktop_View$desktop(
		{
			ctor: '::',
			_0: A2(
				_ahstro$ahstro$Desktop_View$window,
				'Terminal',
				{
					ctor: '::',
					_0: _ahstro$ahstro$Terminal_View$terminal(model),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _ahstro$ahstro$Main$main = _elm_lang$html$Html$program(
	{
		init: _ahstro$ahstro$Model$init,
		view: _ahstro$ahstro$View$view,
		update: _ahstro$ahstro$Update$update,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ahstro$ahstro$Main$main !== 'undefined') {
    _ahstro$ahstro$Main$main(Elm['Main'], 'Main', undefined);
}
